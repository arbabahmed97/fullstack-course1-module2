class Person
  attr_accesor :first_name,:last_name#have a first_name and last_name attribute with public accessors
  #attr_accessor 
  ...
  def initialize(first_name,last_name)
    ...
    self.last_name=last_name#should take 2 parameters for first_name and last_name
    @@people<<self#assign those parameters to instance variables
  ...
  def self.search(last_name)
   @@people.select{|person| person.last_name=last_name} #accept a `last_name` parameter
